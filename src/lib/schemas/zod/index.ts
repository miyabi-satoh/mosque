...
export const UserScalarFieldEnumSchema = z.enum(['id','username','role','fullName','displayName','email']);
...
export const ResourceTempScalarFieldEnumSchema = z.enum(['id','sessionId','state','examType','year','grade','numOf','category','title','shortTitle','path']);
